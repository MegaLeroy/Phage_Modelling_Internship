...
from Test_Utils import Cell, cellStates, color_world, cellTypes, gen_save_plots, init_world, choose_moore_domain, \
...
def mutate(world, row, col, mutationProb, mooreDomain, rng):
    centerCell = world[row][col]  # remove repair function
...
def damage(world, row, col, damageProb, rng):  # remove completely
    centerCell = world[row][col]
